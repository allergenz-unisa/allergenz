...
const FormModificaPortata = () => {
  ...
  useEffect(() => {
    changeTitle('Modifica la portata " ' + ristorante.localName + ' " ');
  }, []);
        ...
        <Grid item xs={12} md={8} lg={6}>
          <Paper>
            ...
            <Typography sx={{ mr: 2, ml: 2, mb: 2 }}>
              {" "}
              Modifica il piatto utilizzando il form sottostante{" "}
            </Typography>
            <List>
              <ListItem>
                <Typography
...
export default FormModificaPortata;
